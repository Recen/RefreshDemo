        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                boolean canFooterMoveUp = mPtrHandler != null && mFooterView != null // The footer view could be null, so need double check
                        && mPtrHandler instanceof PtrHandlerLoadMore && ((PtrHandlerLoadMore) mPtrHandler).checkCanDoLoadMore(this, mContent, mFooterView) && (mMode.ordinal() & 2) > 0;
    ...
    private void performRefresh() {
        ...
        if (mPtrHandler != null) {
            if (mPtrIndicator.isHeader()) {
                ...
                if (mPtrHandler instanceof PtrHandlerLoadMore) {
                    ((PtrHandlerLoadMore) mPtrHandler).onLoadMoreBegin(this);
                }
            }
        }
    }
